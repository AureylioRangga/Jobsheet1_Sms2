public class Fungsi07 {
    ...
    static int hitungPendapatan(int cabang) {
        int total = 0;  // Variabel untuk menyimpan total pendapatan
    ...
    public static void main(String[] args) {
        // Perulangan untuk menghitung pendapatan semua cabang
        for (int i = 0; i < 4; i++) {
            int pendapatan = hitungPendapatan(i);  // Memanggil fungsi hitung pendapatan
